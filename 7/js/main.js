...
const allAdults = people.every(person => ((new Date()).getFullYear()) - person.year >= 19); // Implicit return!
...
const comment = comments.find(comment => comment.id === 823423); // implicit return!
...
console.log('/// Alternate immutable answer');
